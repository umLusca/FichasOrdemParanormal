	...
	<style>
        ...
        */
        ...
        [data-bs-theme=dark] .first  {
            background-image: url("https://fichasop.com/assets/img/background-min.jpeg");
        }

        [data-bs-theme=light] .first  {
            background-image: url("/assets/img/bg_conhecimento_1-min.jpeg");
        }
       .first {
        }
...
<main style="width: calc(100vw - 5px); height: calc(100vh - 45px)" class="first">
	<div class="container position-relative">
		<div class="row row-cols-1 justify-content-between g-2" style="padding-top: calc( 20vh - 5vw )">
			<div>
	...
	<div class="row my-5 row-cols-1 row-cols-md-3 g-3">
		<div class="col">
			<div class="card hover p-2 h-100">
				...
				<p>Com mais de 10.000 pessoas, contamos com a comunidade mais zica que existe, que nos ajudam com
