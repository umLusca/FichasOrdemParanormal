                ...
                <div class="row row-cols-1 row-cols-md-3 g-2">
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0" type="number" min="0" max="999" name="passiva" value="<?= $ficha["passiva"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            <span class="input-group-text  border-end-0">Esquiva:</span>
                            <input class="form-control  border-start-0" type="number" min="0" max="999" name="esquiva" value="<?= $ficha["esquiva"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            <span class="input-group-text  border-end-0">Bloqueio:</span>
                            <input class="form-control  border-start-0" type="number" min="0" max="999" name="bloqueio" value="<?= $ficha["bloqueio"] ?>"/>
                        </label>
                    </div>
                </div>
                    ...
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="mental" value="<?= $ficha["mental"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0" type="number" min="0"
                                   max="50" name="morte" value="<?= $ficha["morte"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="conhecimento" value="<?= $ficha["conhecimento"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="sangue" value="<?= $ficha["sangue"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="energia" value="<?= $ficha["energia"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                    </div>
                ...
                <div class="row row-cols-md-2 row-cols-1 g-1">
                    ...
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="fisica" value="<?=  $ficha["fisica"] ?>"/>
                        </label>
                    </div>
                    <div class="">
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="balistica" value="<?=  $ficha["balistica"] ?>"/>
                        </label>
                    </div>
                    <div>
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="corte" value="<?=  $ficha["corte"] ?>"/>
                        </label>
                    ...
                    <div>
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="impacto" value="<?=  $ficha["impacto"] ?>"/>
                        </label>
                    ...
                    <div>
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="perfuracao" value="<?=  $ficha["perfuracao"] ?>"/>
                        </label>
                    ...
                    <div>
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="eletricidade" value="<?=  $ficha["eletricidade"] ?>"/>
                        </label>
                    ...
                    <div>
                        <label class="input-group input-group-sm">
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="fogo" value="<?=  $ficha["fogo"] ?>"/>
                        </label>
                    ...
                    <div>
                        <label class="input-group input-group-sm"><span
                            ...
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="frio" value="<?=  $ficha["frio"] ?>"/></label>
                    </div>
                    <div>
                        <label class="input-group input-group-sm">
                            <span class="input-group-text  border-end-0">Química:</span>
                            <input class="form-control  border-start-0"
                                   type="number" min="0" max="50" name="quimico" value="<?= $ficha["quimico"] ?>"/>
                        </label>
                    </div>
            ...
            <div class="modal-body justify-content-center text-center">
				...
				if ($k->num_rows) {
					...
					foreach ($k as $r):
                        ...
                        <div class="d-grid gap-2 m-2">
                            <a class="btn btn-primary" href="?token="> <?= $rs["nome"] ?></a>
                        </div>
					<?php
					endforeach;
				}
				...
				if ($k->num_rows) {
					...
					foreach ($k as $r):
						?>
                        <div class="d-grid gap-2 m-2">
                            <a class="btn btn-primary" href="?token="> a</a>
                        </div>
					<?php
					endforeach;
				}
