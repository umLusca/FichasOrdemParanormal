<card_inventario class="card" id="card_inventario">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="top-100 position-sticky">
								<?php if (!empty($arma["ataque"])) { ?>
                                    <div class="d-grid">
                                        <button class="btn btn-sm p-0 btn-outline-info rounded-0 ataque" data-dado="<?= $arma["ataque"] ?>"
                                                onclick='rolar(<?= "[{nome:`Teste {$arma["arma"]}`,dado: `{$arma["ataque"]}`, dano: false,margem:{$arma["margem"]}}" ?>,<?= "{nome:`Dano {$arma["arma"]}`,dado: `{$arma["dano"]}`, dano: 1}" ?>,<?= "{nome:`Crítico {$arma["arma"]}`,dado: `{$arma["critico"]}`, dano: 1}]" ?>)'>
                                            Teste<br>
											<?= $arma["ataque"] ?>
                                        </button>
                                    </div>
