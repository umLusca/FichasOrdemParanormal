    ...
    <div class="card h-100 w-100 bg-black border-light">
        <div class="card-body p-0">
            <div class="card-header border-0">
                <div class="card-title fs-2 text-center font6">Anotações <span id="syncnotes" class="invisible"><i
                                class="fas"></i></span></div>
            </div>
                ...
                <div class="tab-content" id="notes">
					<?php foreach ($nt as $r): ?>
                        <div class="tab-pane fade show" id="a<?= $r["id"] ?>" role="tabpanel"
                            ...
                            <textarea aria-label="a<?= $r["id"] ?>" id="editor1<?= $r["id"] ?>" name="nota[]"
                                      class="note form-control bg-black text-light" rows="10" cols="80"
                                      maxlength="5000"><?= $r["notas"] ?></textarea>
