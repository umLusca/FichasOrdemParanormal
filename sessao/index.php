                                                ...
                                                <?php if ($dl["id_ficha"] > 0) :?>
                                                    <div class="m-1 mb-3">
                                                        ...
                                                        <div class=" position-absolute start-50 translate-middle-x">
                                                            <a class="btn btn-sm btn-outline-info" href="personagem/portrait?token=<?= $cd["token"]; ?>">Portrait</a>
                                                            <a class="btn btn-sm btn-outline-info" href="personagem/impresso?token=<?= $cd["token"]; ?>"><i class="fa-regular fa-print"></i></a>
                                                        </div>
                                        ...
                                        <div class="col-md-6 my-2">
                                            <div class="card h-100 m-2 bg-black border-danger">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-footer">
                                                        <a class="btn btn-outline-danger" href="./mestre/?token=<?=$dl["token"]?>">Painel do Mestre
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card h-100 m-2 bg-black border-primary">
                                                <div class="m-1 mb-3">
                                                    ...
                                                    <div class=" position-absolute start-50 translate-middle-x">
                                                        ...
                                                        <a class="btn btn-sm btn-outline-info" href="personagem/impresso?token=<?= $dl["token"]; ?>"><i class="fa-regular fa-print"></i></a>
                                                    </div>
                                                </div>
                                                <div class="card-body">
