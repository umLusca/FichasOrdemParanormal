...
<form class="modal fade" id="editritual" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-fullscreen modal-dialog">
        <div class="modal-content bg-black border-light">
					...
					foreach ($s[6] as $r):?>
                        <div class="col-md-6">
                            <div class="m-4">
                                <div class="teedfa">
                                    <div class="m-2">
                                        <label for="fotosimbolo<?= $r["id,"] ?>">Foto do ritual
                                            <select class="form-select bg-black text-light border-light fotosimbolo" name="foto[]">
            ...
            <div class="modal-footer">
                <input name="status" value="editritual" type="hidden"/>
                <button type="submit" class="btn btn-success d-grid" value="submit">Salvar</button>
            </div>
        </div>
    </div>
</form>
