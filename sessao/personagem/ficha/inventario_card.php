<div class="col">
    <div class="card" id="card_inventario">
        <div class="card-header d-flex justify-content-between">
			...
			<?php if ($edit) { ?>
                <div class="float-end">
                    <button class="btn btn-sm text-warning fa-lg" data-bs-toggle="modal" data-bs-target="#editpesoinv"
                            title="Editar peso">
        ...
        <div class="card-body p-0">
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-6 g-2 my-2 m-3">
				<?php foreach ($s[8] as $i => $arma): ?>
                    <div class="col">
                        <div class="card h-100 border border-danger position-relative" style="min-height: 100px" id="arma<?= $arma["id"] ?>">
                            ...
                            <div class="card-body p-0">
                                <div class="card-title text-center arma"><?= $arma["nome"] ?> *<?= $arma["id"] ?></div>
