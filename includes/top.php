...
<header class="font5 fixed-top bg-black" id="header">
    <div class="d-flex flex-wrap border-bottom border-light">
        ...
        <div class="col-auto dropdown d-md-none">
            <button title="Menu" class="btn btn-sm text-light" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-regular fa-bars"></i> Menu</button>
