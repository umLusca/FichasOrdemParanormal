...
<main class="container my-5 p-3">
    <form class="card">
        ...
        <div class="card-body">
            <div id="rsmsg"><?php
                if ($aviso) {
		            echo '<div class="alert alert-warning"> ' . $msga . ' </div>';
	            } ?>
            </div>
            <div id="rsbody">
				<?php if (!$aviso) { ?>
                    <div class="input-group p-3">
                        <label for="rsenha" class="input-group-text">Nova senha</label>
                        <input id="rsenha" name="senha" type="password" class="form-control"/>
                    </div>
                    <div class="input-group p-3">
                        <label for="rcsenha" class="input-group-text">Confirmar nova senha</label>
                        <input id="rcsenha" name="csenha" type="password" class="form-control"/>
                    </div>
				<?php } ?>
            </div>
        </div>
