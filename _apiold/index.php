                            ...
                            if (empty($_DATA["sessid"]) || checksession($session_id)) {
                                ...
                                if ($a->num_rows) {
                                    ...
                                    if ((int)$ficha["public"] === 1 || $editable) {
                                        ...
                                        $ficha["pericias"][] = array("nome" => "reflexo", "grau" => $ficha["treflexo"], "bonus" => $ficha["reflexos"], "ramo" => false, "atributoChave" => $atrpericia["reflexo"]);
